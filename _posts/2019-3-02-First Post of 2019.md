...
<form method="post" action="https://poll.pollcode.com/94115599"><div style="background-color:#EEEEEE;padding:2px;width:386px;font-family:Lucida Console;font-size:medium;color:#FFFFFF;background-image: url('https://images.boardhost.com/bg/black_diag');"><div style="padding:2px 0px 4px 2px;"><strong>What is your preferred software dev methodology?</strong></div><input type="radio" name="answer" value="1" id="answer941155991" style="float:left;" /><label for="answer941155991" style="float:left;width:361px;">Agile</label><div style="clear:both;height:2px;"></div><input type="radio" name="answer" value="2" id="answer941155992" style="float:left;" /><label for="answer941155992" style="float:left;width:361px;">Scum</label><div style="clear:both;height:2px;"></div><input type="radio" name="answer" value="3" id="answer941155993" style="float:left;" /><label for="answer941155993" style="float:left;width:361px;">Waterfall (a.k.a. Traditional)</label><div style="clear:both;height:2px;"></div><input type="radio" name="answer" value="4" id="answer941155994" style="float:left;" /><label for="answer941155994" style="float:left;width:361px;">Rapid</label><div style="clear:both;height:2px;"></div><input type="radio" name="answer" value="5" id="answer941155995" style="float:left;" /><label for="answer941155995" style="float:left;width:361px;">DevOps</label><div style="clear:both;height:2px;"></div><input type="radio" name="answer" value="6" id="answer941155996" style="float:left;" /><label for="answer941155996" style="float:left;width:361px;">Spiral</label><div style="clear:both;height:2px;"></div><div align="center" style="padding:3px;"><input type="submit" value=" Vote ">&nbsp;<input type="submit" name="view" value=" View "></div><div align="right" style="font-size:10px">pollcode.com <a href="https://pollcode.com/">free polls</a></div></div></form>
