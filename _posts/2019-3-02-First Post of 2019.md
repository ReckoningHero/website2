...
Agile methods attempt to minimize risk (such as bugs, cost overruns, and changing requirements) by implementing new functionality and developing the software that are mini-increments of the new functionality. The benefit of multiple iterations is to improve efficiency by finding and fixing defects and expectation mismatches early on.
